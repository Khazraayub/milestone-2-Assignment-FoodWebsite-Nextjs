...
export default function Contact() {
  ...
  <div className="container px-5 py-24 pt-48 mx-auto">
    <div className="flex flex-col text-center w-full mb-12">
      <h1 className="sm:text-5xl underline font-extrabold title-font mb-4 ">Contact Us</h1>
    ...
    <div className="lg:w-1/2 md:w-2/3 mx-auto">
      <div className="flex flex-wrap -m-2">
        ...
        <div className="p-2 w-full">
          <button className="flex mx-auto text-black bg-gray-100 border-0 py-2 px-8 focus:outline-none hover:bg-red-600 rounded text-lg">Submit</button>
        </div>
